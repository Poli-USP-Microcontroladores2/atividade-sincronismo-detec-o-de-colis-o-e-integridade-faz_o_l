...
#define PLATE_A 0           /* Defina 1 para PLACA A, 0 para PLACA B */
...
static bool current_is_rx = false;   /* começa em RX por padrão */
static bool start_rx = false;        /* preferencia: se true => botão força RX; se false => força TX */
